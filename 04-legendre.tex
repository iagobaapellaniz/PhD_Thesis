...
The quantum Fisher information is of this type.
...
\be
  \hat{\mathcal{F}}_{\text{Q}}(rW) = \sup_\mu \{\lambda_{\max} (rW-4(J_z-\mu)^2)\}.
\ee
...
\be
  \mathcal{B}_{\mathcal{F}} = \sup_r \big\{ rw - \sup_{\ket{\psi}} \{\expect{rW-4J_z^2} + \expect{2J_z}^2\}\big\}.
\ee
