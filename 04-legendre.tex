...
For that we notice first that $\qfif{\rho,J_z}$ is the convex roof of $4\varian{J_z}$ \citep{}.
...
Below the dashed line $\qfif{\rho,J_z}>N$, hence the state possesses metrologicaly useful entanglement \citep{}.
...
We can compare our estimate to the quantum Fisher information of the state for the experiment of Ref.~\citep{Krischek2011}, where the QFI for the density matrix was obtained as $\qfif{\rho,J_z}/N=(10.326\pm0.093)/N=(2.5816\pm0.02325)$.
