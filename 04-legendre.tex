...
Using Eqs.~, we will obtain an analytical tight lower bound on the QFI based on the fidelity $F_{\text{GHZ}}$. The calsulation that we have to carry out is computing the bound
\be
