...
The reader may note many properties a probability should have, such as that the probability of any event to happen is always given by a number in between zero and one.
