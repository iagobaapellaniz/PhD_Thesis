...
We mention it as a formal description of the entanglement \citep{Guehne2009}.
...
Concepts like genuine multipartite entanglement, $k$-producible states, or entanglement depth, among others, arose from weaker constraints than Eq.~\eqref{eq:bg-separable-state-definition} \citep{Guehne2009}.
...
In many cases it is also usual to merge all into a single, but at the same time with many quantum numbers, state $\ket{\psi}=\ket{m_1 m_2 \dots m_N}$.
Many more details about the notation is normally used in many-body quantum mechanics can be found on different textbooks \citep{}.
...
These transformations are govern by master-equations of the type of the Linblad equation \citep{}.
...
Nevertheless, with the initial pioneering works of W. K. Wotters, and S. L. Braunstein and C. M. Caves, in 1981 and 1994 respectively \citep{Wotters1981, Braunstein1994}, until the works of V. Giovannetti et al, and M. G. Paris, roughly two decades later \citep{Giovannetti2004, Paris2009}, the field of quantum metrology was stabilized with solid foundations.
...
\end{enumerate}
The main relation between the quantum Fisher information and the variance, which analogously to Eq.~\eqref{eq:bg-qfi-definition-convex-roof} can be proven that it is the concave-roof of the variance \citep{MR91}, can be summarized as follows.
