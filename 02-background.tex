...
If this is not the case, the state is said to be \emph{entangled}.
...
Concepts like genuine multipartite entanglement, $k$-producible states, or entanglement depth, among others, arose from weaker constraints than Eq.~\eqref{eq:bg-separable-state-definition} \citep{GuehneXXXX}.
...
\subsubsection{Dynamics of quantum systems, measurements and quantum information}
