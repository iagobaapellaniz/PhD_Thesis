...
To graphically represent states with angular momentum larger than $J=\frac{1}{2}$, it is convenient to use the so-called Husimi $Q$-representation on the Bloch-sphere.
