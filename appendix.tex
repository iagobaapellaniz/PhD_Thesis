...
This is a usual procedure when adding angular momentum operators, see Ref.~\cite{Cohen-Tannoudji1977, Sakurai2014} for more details.
...
\ee
where we simplify the integral using the normalization of the PDF that corresponds to $1$.
