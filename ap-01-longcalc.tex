...
\ee
From all those terms the third is somehow referent, since the pure unpolarised Dicke state used as reference is align with the $x$-axis, so $J_x\ket{\dickeN^{N/2}}_x=0$.
...
\subsubsection{Calculation of $|\braopket{\dicke{N,m}}{_z}{\dicke{N,N/2}}_x|^2$}
