...
We have verified the correctness of our analytical formula with a numeric simulation of the expectation value of Equation~[ERROR PROP. FORM.] and the equation above. The state used for that it is
