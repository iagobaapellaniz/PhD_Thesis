...
\ee
which coincides exactly with the inverse quantum Fisher information for such state \citep{VD48}.
...
\be
  ...
  {4\expect{J_y^2-J_x^2}^2}.
\ee
We have used this formula to compute the bound on the optimal precision with the measured data shown on Eq.~{(XXX)}, $(\Delta \theta)^{-2}_{\text{opt}} \geq 2.9N$, see Figure~
ef{fig:vd-experimental}.
