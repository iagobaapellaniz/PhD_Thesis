...
\fancyhead[RO]{by Iagoba Apellaniz}
...
\lettrine[lines=2, findent=3pt,nindent=0pt]{S}{ample} text.
\input{sample_text.tex}



\section{Background on Estimation and \, Quantum Information Theories}
